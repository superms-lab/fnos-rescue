...
required=(
  ...
  live/config/archives/debian-security.list.chroot
  live/config/archives/debian-security.list.binary
...
grep -q 'bookworm-security' "$ROOT/live/config/archives/debian-security.list.chroot"
